...
public class ECommerce_tc_4_Hybrid extends EcommerceBaseTest {
	@Test
	public void FillForm() throws InterruptedException {
		driver.findElement(By.id("com.androidsample.generalstore:id/nameField")).sendKeys("Dylan Bradford");
		driver.hideKeyboard();
